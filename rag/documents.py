...
def load_documents():
    ...
    # ヨー子リニューアル
    add_document(
        doc_id="press_yoko_renewal",
        text="""
        楯の川酒造の定番人気リキュール「ヨー子」が2023年春にフルリニューアル。
        ヨー子は鳥海山ヨーグルトと楯の川酒造の純米大吟醸をブレンドしたヨーグルトリキュール。
        低アルコールで飲みやすく女性に人気が高い。リキュール部門売り上げランキング常に上位。
        新レシピではヨーグルトの原材料を見直し、さらに滑らかで上品な味わいを実現。
        コンセプトは鳥海山麓の山小屋のBAR「ヨー子」の店主が厳選した素材で作るお酒。
        ラベルデザインもリニューアルし、ヨーグルトの白色と端正なヨー子の横顔を印象的に描いた。
        """,
        metadata={"type": "press_release", "date": "2023-02-17"}
    )
